...
// Estamos trabajando con el algoritmo RSA
public class MainAsimetrico {
	...
	public static void main(String[] args) throws IOException {
		...
		// Ofrecemos el menu
		System.out.println("MENÚ PRINCIPAL CLAVE ASIMÉTRICA, MARQUE UNA OPCIÓN");
		System.out.println("******************************************************");
		...
		try {
			...
			do {
				...
				// Paso 1: creamos un generador de claves en este caso
				// lo creamos con la clase KeyPairGenerator, para que podamos
				// obtener dos claves (pública y privada)
				KeyPairGenerator generador = KeyPairGenerator.getInstance("RSA");

				// Paso 2: generamos dos claves con la clase KeyPair
				KeyPair escitala = generador.generateKeyPair();
				...
				case 2:
					...
					cifrador.init(Cipher.ENCRYPT_MODE, escitala.getPrivate());
				...
				case 3:
					...
					// luego desencriptar. Al ser una opción no dependemos de otras para
				...
				case 4:
					...
					cifrador.init(Cipher.DECRYPT_MODE, escitala.getPublic());
